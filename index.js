...
import { createVisualGeneration } from "./visual/generation.js";
...
function initProfile() {
    ...
    if (!localProfile.npcBank) localProfile.npcBank = defaults.npcBank;
    if (localProfile.npcBank.sendPortraitsToAi === undefined) localProfile.npcBank.sendPortraitsToAi = false;
...
function buildBaseDict() {
    ...
    visualGeneration.extendBaseDict(dict);
...
function handlePromptInjection(data) {
    ...
    // --- INJECT VISUAL GENERATION PROMPTS ---
    if (visualGeneration.handlePromptInjection(messages, disablePrefill)) return;
    ...
    try {
        ...
        if (typeof eventSource !== 'undefined' && typeof event_types !== 'undefined') {
            eventSource.on(event_types.APP_READY, () => {
                ...
                visualGeneration.loadDanbooruTags();
            });
